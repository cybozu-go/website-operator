...
*/}}
{{- define "website-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "website-operator.resourceName" -}}
{{- $fullname := include "website-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
{{- else }}
{{- include "website-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
